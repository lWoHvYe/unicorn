...
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8mb3 COMMENT='代码生成字段信息存储';

-- ----------------------------
-- Records of code_column_config
-- ----------------------------
BEGIN;
INSERT INTO `code_column_config` VALUES (191, 'sys_user', 'user_id', 'bigint', NULL, 'auto_increment', b'1', NULL, 'PRI', b'1', b'0', NULL, 'ID', NULL);
INSERT INTO `code_column_config` VALUES (192, 'sys_user', 'dept_id', 'bigint', NULL, '', b'1', NULL, 'MUL', b'1', b'0', NULL, '部门名称', NULL);
INSERT INTO `code_column_config` VALUES (193, 'sys_user', 'username', 'varchar', NULL, '', b'1', NULL, 'UNI', b'1', b'0', NULL, '用户名', NULL);
INSERT INTO `code_column_config` VALUES (194, 'sys_user', 'nick_name', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '昵称', NULL);
INSERT INTO `code_column_config` VALUES (195, 'sys_user', 'gender', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '性别', NULL);
INSERT INTO `code_column_config` VALUES (196, 'sys_user', 'phone', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '手机号码', NULL);
INSERT INTO `code_column_config` VALUES (197, 'sys_user', 'email', 'varchar', NULL, '', b'1', NULL, 'UNI', b'1', b'0', NULL, '邮箱', NULL);
INSERT INTO `code_column_config` VALUES (198, 'sys_user', 'avatar_name', 'varchar', NULL, '', b'1', NULL, 'MUL', b'1', b'0', NULL, '头像地址', NULL);
INSERT INTO `code_column_config` VALUES (199, 'sys_user', 'avatar_path', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '头像真实路径', NULL);
INSERT INTO `code_column_config` VALUES (200, 'sys_user', 'password', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '密码', NULL);
INSERT INTO `code_column_config` VALUES (201, 'sys_user', 'is_admin', 'bit', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '是否为admin账号', NULL);
INSERT INTO `code_column_config` VALUES (202, 'sys_user', 'enabled', 'bigint', NULL, '', b'1', NULL, 'MUL', b'1', b'0', NULL, '状态：1启用、0禁用', NULL);
INSERT INTO `code_column_config` VALUES (203, 'sys_user', 'description', 'mediumblob', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '描述信息', NULL);
INSERT INTO `code_column_config` VALUES (204, 'sys_user', 'create_by', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '创建者', NULL);
INSERT INTO `code_column_config` VALUES (205, 'sys_user', 'update_by', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '更新者', NULL);
INSERT INTO `code_column_config` VALUES (206, 'sys_user', 'pwd_reset_time', 'datetime', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '修改密码的时间', NULL);
INSERT INTO `code_column_config` VALUES (207, 'sys_user', 'create_time', 'datetime', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '创建日期', NULL);
INSERT INTO `code_column_config` VALUES (208, 'sys_user', 'update_time', 'datetime', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '更新时间', NULL);
INSERT INTO `code_column_config` VALUES (209, 'sys_resource', 'resource_id', 'bigint', NULL, '', b'1', NULL, 'PRI', b'1', b'1', NULL, 'ID', NULL);
INSERT INTO `code_column_config` VALUES (210, 'sys_resource', 'name', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '资源名称', NULL);
INSERT INTO `code_column_config` VALUES (211, 'sys_resource', 'pattern', 'varchar', NULL, '', b'1', NULL, 'MUL', b'1', b'1', NULL, 'URI', NULL);
INSERT INTO `code_column_config` VALUES (212, 'sys_resource', 'status', 'tinyint', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '状态 0-不可用 1-可用', NULL);
INSERT INTO `code_column_config` VALUES (213, 'sys_resource', 'rest_name', 'varchar', NULL, '', b'1', NULL, 'MUL', b'1', b'0', NULL, '所在类名', NULL);
INSERT INTO `code_column_config` VALUES (214, 'sys_resource', 'remark', 'varchar', NULL, '', b'1', NULL, '', b'1', b'0', NULL, '备注', NULL);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='代码生成器配置';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='应用管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='部署管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='部署历史管理';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='应用与服务器关联';
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='服务器管理';
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb3 COMMENT='部门';

-- ----------------------------
-- Records of sys_dept
-- ----------------------------
BEGIN;
INSERT INTO `sys_dept` VALUES (2, 7, 2, '研发部', 3, b'1', 'admin', 'admin', '2019-03-25 09:15:32', '2020-08-02 14:48:47');
...
INSERT INTO `sys_dept` VALUES (8, NULL, 3, '华北分部', 1, b'1', 'admin', 'admin', '2019-03-25 11:04:53', '2020-05-14 12:54:00');
INSERT INTO `sys_dept` VALUES (15, 8, 0, 'UI部门', 7, b'1', 'admin', 'admin', '2020-05-13 22:56:53', '2020-05-14 12:54:13');
INSERT INTO `sys_dept` VALUES (18, 2, 0, '平台开发部', 2, b'1', 'admin', 'admin', '2021-10-23 23:37:25', '2021-10-23 23:37:25');
INSERT INTO `sys_dept` VALUES (19, 2, 0, '产品开发部', 4, b'1', 'admin', 'admin', '2021-10-23 23:38:03', '2021-10-23 23:38:03');
INSERT INTO `sys_dept` VALUES (20, 8, 0, '运营部', 8, b'1', 'admin', 'admin', '2021-11-05 09:57:26', '2021-11-05 09:57:42');
INSERT INTO `sys_dept` VALUES (21, NULL, 2, '华中分部', 7, b'1', 'admin', 'admin', '2021-11-24 18:47:03', '2021-11-24 18:47:03');
INSERT INTO `sys_dept` VALUES (22, 21, 0, '市场部', 1, b'1', 'admin', 'admin', '2021-11-24 18:47:22', '2021-11-24 18:47:31');
INSERT INTO `sys_dept` VALUES (23, 21, 0, '支撑部', 2, b'1', 'admin', 'admin', '2021-11-24 18:47:54', '2022-03-13 21:56:40');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COMMENT='数据字典';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='数据字典详情';
...
CREATE TABLE `sys_job` (
  ...
  KEY `inx_enabled` (`enabled`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb3 COMMENT='岗位';
...
INSERT INTO `sys_job` VALUES (13, '服务端开发', b'1', 8, 'admin', 'admin', '2021-11-05 09:56:17', '2021-11-24 18:46:02');
INSERT INTO `sys_job` VALUES (14, '产品端开发', b'1', 9, 'admin', 'admin', '2021-11-05 09:56:43', '2021-11-05 09:56:43');
INSERT INTO `sys_job` VALUES (15, '产品运营', b'1', 6, 'admin', 'admin', '2021-11-05 22:39:20', '2021-11-05 22:39:20');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3898 DEFAULT CHARSET=utf8mb3 COMMENT='系统日志';
...
CREATE TABLE `sys_menu` (
  ...
  UNIQUE KEY `uniq_name` (`name`) USING BTREE,
  KEY `inx_pid` (`pid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb3 COMMENT='系统菜单';
...
INSERT INTO `sys_menu` VALUES (90, NULL, 4, 1, '运维管理', 'Mnt', '', 20, 'mnt', 'mnt', b'0', b'0', b'0', NULL, NULL, NULL, '2019-11-09 10:31:08', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb3 COMMENT='定时任务';
...
CREATE TABLE `sys_resource` (
  ...
  KEY `pattern` (`pattern`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='资源（API）';

-- ----------------------------
-- Records of sys_resource
-- ----------------------------
BEGIN;
INSERT INTO `sys_resource` VALUES (1, '查询', '/api/**', 'GET', 1, '', '所有查询权限');
INSERT INTO `sys_resource` VALUES (2, '修改', '/api/**', 'PUT', 1, '', '所有修改权限');
INSERT INTO `sys_resource` VALUES (3, '新增', '/api/**', 'POST', 1, '', '所有新增权限');
INSERT INTO `sys_resource` VALUES (4, '删除', '/api/**', 'DELETE', 1, '', '所有删除权限');
INSERT INTO `sys_resource` VALUES (5, '角色模块', '/api/sys/roles**', NULL, 1, 'RoleRest', '角色模块所有权限');
INSERT INTO `sys_resource` VALUES (6, '资源查询', '/api/sys/resources*', 'GET', 1, 'ResourceRest', '资源查询权限');
INSERT INTO `sys_resource` VALUES (7, '系统管理', '/api/sys/**', NULL, 1, NULL, '系统管理模块权限');
INSERT INTO `sys_resource` VALUES (8, '验证码', '/captcha/**', NULL, 1, NULL, '获取验证码');
INSERT INTO `sys_resource` VALUES (9, 'html资源', '/**/*.html', 'GET', 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (10, 'css资源', '/**/*.css', 'GET', 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (11, 'js资源', '/**/*.js', 'GET', 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (12, 'api-docs', '/v3/api-docs/**', NULL, 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (13, 'swagger-ui', '/swagger-ui/**', NULL, 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (14, 'avatar', '/avatar/**', NULL, 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (15, 'file', '/file/**', NULL, 1, NULL, NULL);
INSERT INTO `sys_resource` VALUES (16, 'druid', '/druid/**', NULL, 1, NULL, NULL);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'admin', 1, '- 看起来比较菜', '全部', NULL, 'admin', '2018-11-23 11:04:37', '2021-11-12 18:42:58');
INSERT INTO `sys_role` VALUES (2, '普通用户', 'commin', 2, '普普通通，平平坦坦', '本级', NULL, 'admin', '2018-11-23 13:09:06', '2022-07-16 17:13:51');
INSERT INTO `sys_role` VALUES (3, '产品运营', 'product', 2, '产品运营及输出，瑞star', '本级', 'admin', 'admin', '2021-11-05 22:40:03', '2022-07-19 21:17:02');
INSERT INTO `sys_role` VALUES (4, '大佬', 'dalao', 4, NULL, '自定义', 'admin', 'admin', '2021-11-06 19:57:46', '2021-11-09 21:03:27');
INSERT INTO `sys_role` VALUES (5, 'Java 从精通到陌生', 'java', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:25:28', '2021-11-24 18:49:45');
INSERT INTO `sys_role` VALUES (6, 'C语言 从看懂到看开', 'c', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:25:58', '2021-11-24 18:55:05');
INSERT INTO `sys_role` VALUES (7, 'Python', 'python', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:26:08', '2021-11-08 12:26:08');
INSERT INTO `sys_role` VALUES (8, 'IOS', 'ios', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:26:31', '2021-11-08 12:26:31');
INSERT INTO `sys_role` VALUES (9, 'Android 从入门到改行', 'android', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:26:49', '2021-11-24 18:50:08');
INSERT INTO `sys_role` VALUES (10, 'C++', 'c++', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:27:02', '2021-11-08 12:27:02');
INSERT INTO `sys_role` VALUES (11, 'JavaScript全栈开发 从入门到单身狗', 'js', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:27:28', '2021-11-24 18:53:11');
INSERT INTO `sys_role` VALUES (12, 'Golang', 'go', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:28:04', '2022-03-13 21:59:41');
INSERT INTO `sys_role` VALUES (13, 'PHP 从放弃到坚持放弃', 'php', 3, NULL, '本级', 'admin', 'admin', '2021-11-08 12:28:13', '2021-11-24 18:51:15');
INSERT INTO `sys_role` VALUES (14, 'C# 从入门到放弃', 'c#', 3, NULL, '全部', 'admin', 'admin', '2021-11-24 18:50:45', '2021-11-24 18:50:45');
INSERT INTO `sys_role` VALUES (15, 'SQL Server 没入门就放弃', 'sql_server', 3, NULL, '全部', 'admin', 'admin', '2021-11-24 18:53:44', '2021-11-24 18:53:44');
INSERT INTO `sys_role` VALUES (16, '匿名', 'anonymous', 4, '五彩斑斓的透明', '本级', 'admin', 'admin', '2021-11-30 10:10:20', '2022-03-20 00:19:38');
COMMIT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='角色部门关联';

-- ----------------------------
-- Records of sys_roles_depts
-- ----------------------------
BEGIN;
INSERT INTO `sys_roles_depts` VALUES (4, 2);
INSERT INTO `sys_roles_depts` VALUES (4, 6);
COMMIT;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='角色菜单关联';
...
INSERT INTO `sys_roles_menus` VALUES (14, 4);
INSERT INTO `sys_roles_menus` VALUES (7, 6);
INSERT INTO `sys_roles_menus` VALUES (9, 6);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_roles_resources` VALUES (1, 1);
INSERT INTO `sys_roles_resources` VALUES (1, 2);
INSERT INTO `sys_roles_resources` VALUES (1, 3);
INSERT INTO `sys_roles_resources` VALUES (1, 4);
INSERT INTO `sys_roles_resources` VALUES (2, 1);
INSERT INTO `sys_roles_resources` VALUES (2, 5);
INSERT INTO `sys_roles_resources` VALUES (3, 6);
INSERT INTO `sys_roles_resources` VALUES (6, 7);
INSERT INTO `sys_roles_resources` VALUES (16, 8);
INSERT INTO `sys_roles_resources` VALUES (16, 9);
INSERT INTO `sys_roles_resources` VALUES (16, 10);
INSERT INTO `sys_roles_resources` VALUES (16, 11);
INSERT INTO `sys_roles_resources` VALUES (16, 12);
INSERT INTO `sys_roles_resources` VALUES (16, 13);
INSERT INTO `sys_roles_resources` VALUES (16, 14);
INSERT INTO `sys_roles_resources` VALUES (16, 15);
INSERT INTO `sys_roles_resources` VALUES (16, 16);
...
CREATE TABLE `sys_user` (
  ...
  KEY `inx_enabled` (`enabled`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb3 COMMENT='系统用户';

-- ----------------------------
-- Records of sys_user
-- ----------------------------
BEGIN;
INSERT INTO `sys_user` VALUES (1, 2, 'admin', '管理员-咸鱼', '男', '18888888888', '201507802@qq.com', 'avatar-20200806032259161.png', '/Users/jie/Documents/work/me/admin/eladmin/~/avatar/avatar-20200806032259161.png', '$2a$10$tm56TdWtcFwRdo2VurgDUuqdThBEK0yN5kJBl9FHprXAnqz23hlL6', b'1', 1, 0xE592B8E9B1BC2DE4B88DE7BFBBE8BAAB, NULL, 'admin', '2021-11-11 12:25:14', '2018-08-23 09:11:56', '2021-11-24 18:45:19');
INSERT INTO `sys_user` VALUES (2, 6, 'test', '测试-大佬', '男', '19999999999', 'test@eladmin.com', NULL, NULL, '$2a$10$4XcyudOYTSz6fue6KFNMHeUQnCX5jbBQypLEnGk1PmekXt5c95JcK', b'0', 1, 0xE4B880E58FAA206C6974746C6520, 'admin', 'admin', '2022-04-03 11:48:23', '2020-05-05 11:15:49', '2022-04-01 07:54:28');
INSERT INTO `sys_user` VALUES (3, 20, 'performer', '运营-产品', '女', '18288888888', 'perform@eladmin.com', NULL, NULL, '$2a$10$uUHeP2O2SJGAAcK6ZiLLDuaI/i/8.g4VpyW3EXI0n3FTJ9zsfADs2', b'0', 1, 0xE4BAA7E59381E8BF90E890A5, 'admin', 'admin', '2022-04-01 11:53:12', '2021-11-05 22:38:56', '2022-06-07 08:15:05');
COMMIT;
...
INSERT INTO `sys_users_jobs` VALUES (3, 10);
INSERT INTO `sys_users_jobs` VALUES (3, 15);
COMMIT;
...
INSERT INTO `sys_users_roles` VALUES (3, 3, 3);
INSERT INTO `sys_users_roles` VALUES (2, 4, 4);
INSERT INTO `sys_users_roles` VALUES (2, 6, 5);
COMMIT;
...
CREATE TABLE `tool_email_config` (
  ...
  PRIMARY KEY (`config_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='邮箱配置';
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='本地存储';
...
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `sys_role_view` AS select `sys_role`.`role_id` AS `role_id`,`sys_role`.`name` AS `name`,`sys_role`.`code` AS `code`,`sys_role`.`description` AS `description` from `sys_role`;

-- ----------------------------
-- View structure for sys_user_view
-- ----------------------------
DROP VIEW IF EXISTS `sys_user_view`;
CREATE ALGORITHM = UNDEFINED SQL SECURITY DEFINER VIEW `sys_user_view` AS select `sys_user`.`user_id` AS `user_id`,`sys_user`.`username` AS `username`,`sys_user`.`phone` AS `phone`,`sys_user`.`password` AS `password`,`sys_user`.`enabled` AS `enabled` from `sys_user`;
