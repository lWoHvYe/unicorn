...
import sample.vo.SessionAttributeForm;
...
public class SessionController {
    ...
    public String setAttribute(@ModelAttribute SessionAttributeForm sessionAttributeForm, WebSession session) {
        session.getAttributes().put(sessionAttributeForm.attributeName(), sessionAttributeForm.attributeValue());
        return "redirect:/public/webView";
    }
