 ...
 */
package com.lwohvye.unicornopenai.service;
...
public class WeatherService {
    ...
    // 这里参数如果写city，当提供state code NY时，AI会让提供city name，这一点还是挺智能的
    @Tool(description = "Get latitude and longitude for given state, Input is Two-letter US state code (e.g. CA, NY)")
    public Location getLocationByState(String state) {
        /* 后续通过Google Map的API来获取
