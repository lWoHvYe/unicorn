...
/**
 * 挺全面的一个demo。虽然长，但存在很多的相似性
 *
 * @date 2023/4/19 9:38 AM
 */
...
//        final Payload payload = parseJWT.getPayload();
    ...
    void jwsRSA() throws Exception {
        ...
        //keyId
        String keyId = RandomStringUtils.random(16);
...
//        Payload payload = new Payload(payloadText);
        ...
        final var objectMap = payload1.toJSONObject();
        assertNotNull(objectMap);

        assertEquals(payloadText, objectMap.get("payloadText"));
...
//        JWSHeader header = new JWSHeader.Builder(JWSAlgorithm.ES384).keyID(keyId).build();
     ...
     */
    @Test
    void jwtRSAEncryption() throws Exception {
